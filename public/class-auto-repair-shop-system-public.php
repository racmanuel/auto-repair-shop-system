 ...
 * @subpackage Auto_Repair_Shop_System/public
 */
 ...
 */
class Auto_Repair_Shop_System_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/auto-repair-shop-system-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/auto-repair-shop-system-public.js', array( 'jquery' ), $this->version, true );
	 ...
	 *
	 * Shortcode can take attributes like [auto-repair-shop-system-shortcode attribute='123']
	 * Shortcodes can be enclosing content [auto-repair-shop-system-shortcode attribute='123']custom content[/auto-repair-shop-system-shortcode].
	 *
	 ...
	 */
	public function auto_repair_shop_system_shortcode_func( $atts, $content = null, $tag ) {
